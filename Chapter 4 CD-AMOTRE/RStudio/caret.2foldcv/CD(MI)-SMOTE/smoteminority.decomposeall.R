smoteminority.decomposeall <- function(data,method,perc.over) {
  ...
  for(f.test in folds.data)
  {
    ...
    #append smote.minority.train.append.minority.test
    smote.minority.train.append.minority.test.data <- rbind(smote.minority.train.data,minority.test.data,fill=TRUE)
    minority.data <- smote.minority.train.append.minority.test.data 
    ...
    #get size of smote minority train data
    dim.smote.minority.train.data <- dim(smote.minority.train.data)
    dim.smote.minority.train.data[1]
    ...
    smote.minority.train.data <- minority.data[1:dim.smote.minority.train.data[1],]
    minority.test.data <- minority.data[dim.smote.minority.train.data[1]:dim.minority.data[1],]
    ...
    train.data <- rbind(smote.minority.train.data,majority.train.data)
