ensemble.iForest.update.FP.chunk <- function(data,e.size,kmeans.method, nt,phi.param,ascore.thresh,FP.chunk.size) {
  
  main.dir <- 'C:/Users/fatima/Documents/RStudio/workspace/oneclass.test'
  sub.dir <- paste(e.size,kmeans.method,nt,phi.param,ascore.thresh,FP.chunk.size,sep=',')
